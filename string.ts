...
var Number1:string|null = prompt("Enter Number")

var operator:string|null = prompt("Enter Operater")

var Number2:string|null = prompt("Enter Number")

var num1: number = Number(Number1)
var num2: number = Number(Number2)

var Calculator: string = String(operator)
